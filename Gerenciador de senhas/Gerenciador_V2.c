            ...
            case 2: {
                ...
                switch(respVS) {
                    case 1: {
                        ...
                        while(fread(&temp, sizeof(GerenciadorSenhas), 1, arquivo)) { //GUARDA OS BYTES DE 1 STRUCT DE ARQUIVO DENTRO DO ENDEREÇO DE TEMP, O WHILE SO TERMINA QUANDO O FREAD NAO CONSEGUE LER MAIS BYTES
